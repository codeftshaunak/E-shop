...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `product` SET `title` = '$title' , `description` = '$description', `brand` = '$brand', `price` = '$price', `image`='$target_file'  WHERE `product`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
    ...
    // Sql query to be executed
  $sql = "INSERT INTO `product` (`title`, `description`, `brand`, `price`, `image`) VALUES ('$title', '$description', '$brand', '$price', '$target_file')";
  $result = mysqli_query($conn, $sql);
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="./products.php" method="POST" enctype='multipart/form-data' id='form-box'>
...
<div class="container my-4">
    ...
    <form action="./products.php" method="POST" enctype='multipart/form-data' id='form-box'>
        ...
        <div class="form-group">
            <div class="form-group d-flex flex-column">
                <label for="img" class='p-1'>Product's Image</label>
                <input type="file" name="pImage" id="pImage" class="form-control mb-1">
            </div>
        </div>
